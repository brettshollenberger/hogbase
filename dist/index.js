...
var ExperimentsContext = require$$0.createContext(undefined);
var ExperimentsProvider = function (_a) {
    ...
    var _d = require$$0.useState({}), activeExperiments = _d[0], setActiveExperiments = _d[1];
    var _e = require$$0.useState(false), adminPanelVisible = _e[0], setAdminPanelVisible = _e[1];
    var lovableEnvironment = isLovableEnvironment();
    require$$0.useEffect(function () {
        // Initialize from URL parameters
        var urlExperiments = parseExperimentParams();
        setActiveExperiments(function (prev) { return (tslib.__assign(tslib.__assign(tslib.__assign({}, defaultValues), prev), urlExperiments)); });
    ...
    var setExperimentVariant = function (experimentName, value) {
        setActiveExperiments(function (prev) {
            var _a;
            return (tslib.__assign(tslib.__assign({}, prev), (_a = {}, _a[experimentName] = value, _a)));
        });
...
var AdminPanel = function () {
    var context = require$$0.useContext(ExperimentsContext);
    if (!context)
    ...
    return (jsxRuntimeExports.jsxs("div", { style: panelStyle, children: [jsxRuntimeExports.jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', marginBottom: '15px' }, children: [jsxRuntimeExports.jsx("h3", { style: { margin: 0 }, children: "Experiment Controls" }), jsxRuntimeExports.jsx("button", { onClick: toggleAdminPanel, style: {
                            background: 'none',
                            border: 'none',
                            color: '#ffffff',
                            cursor: 'pointer',
...
var posthog_key = undefined.VITE_POSTHOG_KEY;
...
var identify = function (userId, traits) {
    ...
    if (currentDistinctId !== userId || ((_b = window.__user) === null || _b === void 0 ? void 0 : _b.email) !== (traits === null || traits === void 0 ? void 0 : traits.email)) {
        if (userId) {
            ...
            window.__user = tslib.__assign({ id: userId }, traits);
        }
    }
};
...
var trackSignupError = function (error, tier) {
    trackEvent("signup_error", tslib.__assign({ error: error }, (tier && {
        tier_id: tier.id,
        tier_name: tier.name,
    })));
};
...
function usePricingSignup() {
    var _this = this;
    var _a = require$$0.useState(""), email = _a[0], setEmail = _a[1];
    var _b = require$$0.useState(null), selectedTier = _b[0], setSelectedTier = _b[1];
    var _c = require$$0.useState(false), isSubmitting = _c[0], setIsSubmitting = _c[1];
    var _d = require$$0.useState(false), showModal = _d[0], setShowModal = _d[1];
    /**
     ...
     */
    var handleSubmit = function (e) { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    adminEmails = ((_a = undefined.VITE_ADMIN_EMAILS) === null || _a === void 0 ? void 0 : _a.split(",").map(function (email) {
                        return email.trim();
                    })) || [];
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("https://cprlzjigtonyooedikbe.supabase.co/functions/v1/signup", {
                            ...
                            headers: {
                                ...
                                Authorization: "Bearer ".concat(undefined.VITE_SUPABASE_KEY),
                            },
                            body: JSON.stringify({
                                email: email,
                ...
                case 4:
                    ...
                    trackSignupError(error_1 instanceof Error ? error_1.message : "Failed to sign up", selectedTier
                        ...
                        : undefined);
                    sonner.toast.error(error_1 instanceof Error
                        ? error_1.message
